 ...
 * @since Jul 24, 2003
 */
// eoneil: this class has no abstract methods, but still depends
// on subclassing via testing for instanceOf DirectedGraph/UnDirectedGraph
// which is satisfied by subclass implementing one of these interfaces
